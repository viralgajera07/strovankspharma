...
export default function ContactSection({ onShowToast }) {
  ...
  return (
    <section id="contact" className="section bg-white relative border-t border-slate-200/70 py-16 md:py-24">
      <div className="container relative z-10 px-4 md:px-8 mx-auto max-w-7xl">

        {/* Section Header */}
        <div className="section-header text-center max-w-2xl mx-auto mb-12 md:mb-14">
          ...
          <p className="section-subtitle text-slate-600 text-base leading-relaxed">
            Connect with our sales and technical team for product pricing, PCD franchise monopoly rights, or custom manufacturing quotes.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Left Column: Corporate Info & Map */}
          <div className="lg:col-span-5 flex flex-col gap-6">

            {/* Corporate Details Glass Card */}
            <div className="contact-glass-card p-6 md:p-8 bg-white border border-slate-200/80 rounded-2xl space-y-6 flex-1 flex flex-col justify-between">
                ...
                <div className="space-y-5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        <a 
                          ...
                          className="px-3 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md text-xs font-medium border border-slate-200 flex items-center gap-1.5 transition-all"
                        >
                        ...
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer" 
                          className="px-3 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-md text-xs font-medium border border-emerald-200/60 flex items-center gap-1.5 transition-all"
                        >
                          WhatsApp
                        </a>
                      </div>
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">Sunday: Closed</div>
                    </div>
                  </div>
              ...
              {/* GST Footer */}
              <div className="pt-3.5 border-t border-slate-100 flex items-center justify-between gap-2 text-xs bg-slate-50/80 p-3 rounded-lg border border-slate-200/60 mt-4">
            ...
            {/* Embedded Map Card */}
            <div className="contact-glass-card p-5 bg-white border border-slate-200/80 rounded-2xl flex flex-col">
              ...
              <div className="map-embed-wrapper rounded-xl overflow-hidden border border-slate-200/80 bg-slate-100">
                <iframe
          ...
          {/* Right Column: Redesigned Send Direct Inquiry Form Card */}
          <div className="lg:col-span-7 flex flex-col">
            <div className="contact-glass-card p-6 md:p-8 bg-white border border-slate-200/80 rounded-2xl flex-1 flex flex-col justify-between">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="contact-input-wrapper">
                        ...
                        <input
                          ...
                          className="input-field input-field-iconic h-11"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="contact-input-wrapper">
                        ...
                        <select
                          ...
                          className="input-field input-field-iconic h-11 bg-white text-slate-900 cursor-pointer"
                        >
                  ...
                  <div>
                    ...
                    <div className="contact-input-wrapper items-start">
                      ...
                      <textarea
                        ...
                        className="input-field input-field-iconic py-2.5"
                      ></textarea>
                    </div>
                  </div>
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="btn btn-primary w-full py-3.5 text-base rounded-xl font-extrabold shadow-lg hover:shadow-cyan-500/25 transition-all flex items-center justify-center gap-2.5 group cursor-pointer"
                    >
                      {isSubmitting ? (
                        ...
                        <span className="flex items-center gap-2">
                          ...
                          <ArrowRight className="w-4.5 h-4.5 opacity-80 group-hover:opacity-100 transition-all group-hover:translate-x-1" />
                        </span>
                      )}
                    </button>
                  </div>
              ...
              {/* Trust Footprint Row - Clean & Minimalist */}
